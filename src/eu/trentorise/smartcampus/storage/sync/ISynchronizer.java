...
/**
 * Interface for custom remote data synchronization calls
 * @author raman
 *
 */
public interface ISynchronizer {
	...
	/**
	 * Perform the remote synchronization call.
	 * @param version last local version
	 * @param in locally changed data to be synchronized to server
